...
public class MypageController {
	...
	// 회원정보수정
	@RequestMapping(value = "/edit_myprofile", produces = "text/html; charset=utf-8")
	public String edit(String email, String pw, String name, String phone, Model model, HttpSession session,
