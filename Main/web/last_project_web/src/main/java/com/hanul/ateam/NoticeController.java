...
//	
	//공지사항 삭제처리 요청
	@RequestMapping("/delete_web.no")
	public String delete(int id, HttpServletRequest request) {
		service.notice_delete(id);
	
		//응답화면연결
		return "redirect:list_web.no";
	}
...
//		}
		...
		//응답화면 연결
		return "redirect:detail_web.no?id="+vo.getId();
	}
...
//	
	//공지글 상세화면 요청
	@RequestMapping("/detail_web.no")
	public String detail(int id, Model model) {
		/*
		 * //조회수 증가시키기 service.notice_read(id);
		 */
